      ...
      <main className="bg-[var(--slot4-panel-bg)] text-[var(--slot4-page-text)]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          <div>
            ...
            <h1 className="editable-display mt-4 max-w-xl text-4xl font-normal leading-[1.1] tracking-[-0.02em] sm:text-5xl">{pagesContent.auth.login.title}</h1>
          ...
          <div className="rounded-[var(--editable-radius-card)] border border-[var(--editable-border)] bg-[var(--slot4-surface-bg)] p-7 sm:p-9">
            <h2 className="editable-display text-2xl font-normal tracking-[-0.01em]">{pagesContent.auth.login.formTitle}</h2>
