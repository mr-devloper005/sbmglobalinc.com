export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'sbmglobalinc',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Sbmglobalinc',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'sbmglobalinc.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://sbmglobalinc.com',
